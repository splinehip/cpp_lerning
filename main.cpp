...
int main (int argc, char* argv[])
{
    ...
    {
        std::cout << "Generate integers numbers array of n length and searching k number in this array using binary search" << std::endl;
        int64_t n, k;
    ...
    {
        int m, n;
        std::cout << "Searching the greatest common divisor (GCD) for m and n numbers" << std::endl;
    ...
    {
        std::cout << "Creating the linked list array, fill it of random values in range 0 - 10.000 and print it" << std::endl;
        int64_t n;
    ...
    {
        std::cout << "Generate integers numbers array, fill it of random values in range 0 - 10.000, then sorting it using \"selection sort\"" << std::endl;
        int n;
    ...
    else if (argv[1] == std::string("-h") || argv[1] == std::string("--help") ||  argv[1] == std::string("?"))
    {
        std::cout << std::endl
                  <<" For usage: test <options>" << std::endl << std::endl
                  <<" -bs  --- Generate integers numbers array of n length and searching k number in this array using binary search" << std::endl
                  <<" -bdg --- Generate binary digits of n length" << std::endl
                  <<" -gcd --- Searching the greatest common divisor (GCD) for m and n numbers" << std::endl
                  <<" -f   --- Getting the factorial using recursion for n number" << std::endl
                  <<" -ll  --- Creating the linked list array, fill it of random values in range 0 - 10.000 and print it" << std::endl
                  <<" -ss  --- Generate integers numbers array, fil it of random values in range 0 - 10.000, then sorting it using \"selection sort\"" << std::endl << std::endl
